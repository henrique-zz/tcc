...
if __name__ == "__main__":
    pasta_origem = Path(r"C:\Users\Henrique S\Downloads\tcc\tcc-refatorado\datasets\corsican-dataset") 
    
    pasta_destino = Path(r"C:\Users\Henrique S\Downloads\tcc\tcc-refatorado\datasets\corsican-dataset\Detection")

    # 3. Configurações matemáticas 
    config = {
        'kernel_size': 5,
        'merge_margin': 10,
        'min_area_pct': 0.001,
    ...
    print("🔥 Iniciando o processamento do dataset Corsican...")
    preparar_dataset(pasta_origem, pasta_destino, config)
